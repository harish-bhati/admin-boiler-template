...
const Transactions = () => {
  return (
    <div className="card-container shadow-sm rounded-xl min-w-[150px] border m-5">
      ...
      <a className="py-2 px-6 border border-black-lighter rounded-full text-[14px] text-grey-light font-latoB " href="">View Transaction History</a>
      <a className="py-2 px-6 rounded-full text-[14px] text-white-light font-latoB bg-blue-lighter" href="">Create New Transactions</a>
      </div>
    </div>
  );
};
